...
class OrderForm extends Component
{
    ...
    public function saveProduct($index): void
    {
        ...
        $product = $this->allProducts
            ->find($this->orderProducts[$index]['product_id']);
    ...
    public function save(): RedirectResponse|Redirector
    {
        ...
        return redirect()->route('orders.index')
            ->with('message', 'Order successfully ' . $message);
    }
    ...
    public function render(): View
    {
        ...
        foreach ($this->orderProducts as $orderProduct) {
            if ($orderProduct['is_saved']
                ...
                $this->order->subtotal +=
                    $orderProduct['product_price'] * $orderProduct['quantity'];
            }
        }

        $this->order->total =
            $this->order->subtotal * (1 + $this->taxesPercent / 100);
        $this->order->taxes =
